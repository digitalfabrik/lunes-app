...
describe('FeedbackModal', () => {
  ...
  it('should have a disabled send button when message is empty', () => {
    const { getByText, getByPlaceholderText } = render(
      <FeedbackModal
        visible
        onClose={onClose}
        feedbackFor={{ type: FeedbackType.vocabularyItem, vocabularyItemRef: { type: 'lunes-standard', id: 1 } }}
      />,
    )
  ...
  it('should send feedback', () => {
    ...
    expect(sendFeedback).toHaveBeenCalledWith('Mein Feedback app-team@lunes.de', {
      type: FeedbackType.vocabularyItem,
      vocabularyItemRef: { type: 'lunes-standard', id: 1 },
    })
  })
})
