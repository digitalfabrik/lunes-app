...
describe('evaluateSpeechMatch', () => {
  ...
  describe('when the speech recognizer drops a suffix from a long compound word', () => {
  ...
  describe('when the recognizer cuts off speech mid-word', () => {
    it('should return correct when the transcript is a prefix covering ≥ 65% of the expected phrase', () => {
      // Android voice activity detection may stop recognition before the final syllables of a long
    ...
    it('should return correct when the recognizer drops a Greek-origin plural suffix', () => {
    ...
    it('should not match when the transcript is not a prefix of the expected phrase', () => {
  ...
  describe('when the speech recognizer mishears a German silent-h or th digraph', () => {
    it('should return correct when the speech recognizer returns "steht" for "Stethoskop"', () => {
  ...
  describe('when transcript is phonetically close to the expected word', () => {
    ...
    it('should return correct when the speech recognizer drops a geminate consonant', () => {
    ...
    it('should return correct when the speech recognizer drops a geminate consonant in a longer word', () => {
  ...
  describe('when the speech recognizer adds extra words around the correct phrase', () => {
    it('should return correct when the speech recognizer prepends a filler word', () => {
      // The speech recognizer may start the transcript with a filler word like "Und" even when the user just said the word
    ...
    it('should not match as correct when the phrase is embedded in a longer transcript', () => {
