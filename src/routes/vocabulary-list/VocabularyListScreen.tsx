...
const VocabularyListScreen = ({navigation, route}: VocabularyListScreenPropsType): JSX.Element => {
    ...
    const renderItem = ({item, index}: { item: DocumentType, index: number }): JSX.Element => <VocabularyListItem
        document={item}
            ...
            {!documents || !documents[selectedDocumentIndex] ? <></> :
                <Modal animationType="slide" transparent={true} visible={isModalVisible}>
                    <ModalContainer>
                        ...
                        <ItemContainer>
                            <SingleChoiceListItem answer={{
                                word: documents[selectedDocumentIndex].word,
                                article: documents[selectedDocumentIndex].article
                            }}
                                                  onClick={() => {
                                                  }} correct={false} selected={false} anyAnswerSelected={false}
                                                  delayPassed={false} disabled={true}/>
                        </ItemContainer>
                        <ButtonContainer>
