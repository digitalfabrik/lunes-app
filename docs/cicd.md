...
| CREDENTIALS_DIRECTORY_PATH     | Path where the credentials Git repository cloned to automatically by FL                                    | The developer can choose this freely                                     | ~/credentials                                                                                          | -                                                                            |
| CREDENTIALS_KEYSTORE_PATH      | Path to the GPG encrypted Java Keystore file                                                               | -                                                                        | ~/credentials/<secret>.gpg                                                                             | Look for the `gpg` command in the Android Fastlane file for more information |
| CREDENTIALS_KEYSTORE_PASSWORD  | Password for decrypting the keystore using GPG                                                             |                                                                          | password                                                                                               | -                                                                            |
| KEYSTORE_PATH                  | Path to the decrypted Java Keystore file                                                                   | -                                                                        | ~/keystore.jks                                                                                         | -                                                                            |
